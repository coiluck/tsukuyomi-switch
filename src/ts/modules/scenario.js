...
export const openingScenario = [
  ...
  {
    text: '「で、でも今回は違うよ！ この本、出品者の評価も星五つだったし、『悪魔召喚の実績あり』って書いてあったもん！」',
    speaker: 'ルカ',
    action: async () => {
  ...
  b06: [
    ...
    },
    {
      ...
      branch: [
        ...
        {
          text: '「とりあえず、その制服じゃ動きにくいよね。着替え、貸してあげる」',
          speaker: 'ルカ',
          action: async () => {
            changeCharacterImage('ruka', 'base', true);
          }
  ...
  f01: [
    {
      ...
      branch: [
        ...
        { text: '「あ...！」' },
        { text: '言われてみればそうだ。今の俺の声は、可憐な美少女ボイスそのものだ。' },
        { text: '「...風邪引いて喉が潰れたフリをするか。できるだけ低い声で...」' },
        { text: '俺はゴホン、と一つ咳払いをして、意識して声を低く唸らせた。' },
        { text: '「...あー、あー...よし」' },
        { text: '覚悟を決めて通話ボタンを押す。' },
        {
          text: '『お兄ちゃん！？ 今どこにいるの！』',
        ...
        { text: '怒気を含んだ声。予想通りだ。' },
        { text: '「...あー...ごほっ、ごほっ...」' },
        { text: '俺はわざとらしく咳き込み、掠れた声を絞り出す。' },
        { text: '「...わるい、ひな...」' },
        {
          text: '『え...？ 何その声、変じゃない？』',
          speaker: 'ひな',
        },
        { text: '「...ちょっと、風邪引いたみたいで...喉が...」' },
        {
          text: '『...ふーん？ まあ、昨日の夜から連絡つかなかったもんね』',
          speaker: 'ひな',
        },
        { text: 'ひなは少し不審がりながらも、怒りの方が勝っているようで深くは追求してこなかった。' },
        {
          text: '「あー、昨日は...」',
          choiceId: 'f02',
        },
        { text: '「と、友達の家だ...ごほっ。急に泊まることになって...」' },
        { text: '俺はとっさに嘘をついた。' },
        {
          text: '『友達？ 男友達？』',
          speaker: 'ひな',
    ...
    },
    {
      ...
      branch: [
        ...
        { text: '「この声じゃ出られないよ。バレちまう」' },
        { text: '俺は着信を拒否し、メッセージアプリを開く。' },
        { text: 'そこには、ひなからの大量のメッセージと怒りのスタンプが届いていた。' },
        {
          text: '『どこにいるの？』',
          speaker: 'ひな',
        },
        ...
        { text: '「とりあえず、返信しないと」' },
        { text: '俺は震える指で入力する。' },
        { text: '『今、友達の家にいる。電話はちょっと出られない』' },
        { text: '送信すると、即座に既読がついた。' },
        {
          text: '『友達って誰？ 男？』',
          speaker: 'ひな',
        },
        { text: '鋭いツッコミが入る。' },
        { text: '『男友達だよ。急に泊まることになって』' },
        { text: 'とっさに嘘のメッセージを送る。' },
        {
          text: '『...ふーん。お兄ちゃんに、急に泊まりに行くような仲のいい男友達なんていたっけ？』',
          speaker: 'ひな',
        },
        { text: 'テキストなのに、ひなの冷ややかな視線を感じるようだ。' },
        {
          text: '『まあいいけど...。今日は帰ってくるんだよね？』',
          speaker: 'ひな',
        },
        { text: '『帰るよ』' },
        { text: '返信すると、既読がついたまま反応が止まった。' },
        { text: '「...とりあえず、納得はしてくれたみたいだ」' },
        {
          text: '「よかったね...」',
          speaker: 'ルカ',
          action: async () => {
  ...
  f03: [
    ...
    },
    {
      ...
      branch: [
        ...
        { text: 'ひなが飛び出してくる。' },
        {
          text: '「遅い！ 昨日帰ってこないし、急に友達の家に泊まったなんて言うし...」',
          speaker: 'ひな',
          action: async () => {
            changeCharacterImage('hina', 'jitome', true);
          }
